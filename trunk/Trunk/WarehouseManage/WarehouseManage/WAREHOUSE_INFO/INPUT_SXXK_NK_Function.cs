    ...
    public partial class Form1
    {
        ...
        private bool Import_INPUT_SXXK_NK_Table_in_file(string file_name)
        {
            ...
            if (INPUT_SXXK_NK_Get_Col_info(OpenWB) == true)
            {
                ...
                while (cell_str != "")
                {
                    so_tk = Get_Text_Cell((Excel.Worksheet)OpenWB.Sheets[1], row, INPUT_SXXK_NK_Col[INPUT_SXXK_NK_So_TK].Col, INPUT_SXXK_NK_Col[INPUT_SXXK_NK_So_TK].Data_Max_len);
                    ...
                    //if (Is_exist_SXXK_NK(so_tk, ngay_dk, ma_loai_hinh) == true)
                    //{
                    //    // Update for this row
        ...
        private bool Is_exist_SXXK_NK(string sotk, string ngaydk, string ma_loaihinh)
        {
        ...
        private bool Update_SXXK_NK_Line(string so_tk, string ngay_dk, string ma_loaihinh, Excel.Worksheet xsheet, int row)
        {
            ...
            foreach (DataRow dt_row in INPUT_NK_Table_Form.Data_dtb.Rows)
            {
                ...
                cur_ngay_dk = dt_row[INPUT_SXXK_NK_Col[INPUT_SXXK_NK_Ngay_DK].DB_str].ToString().Trim();
        ...
        private bool Create_New_SXXK_NK_Line(string so_tk, string ngay_dk, string ma_loaihinh, Excel.Worksheet xsheet, int row)
        {
